  ...
  if (type === 'structured' && field) {
    ...
    switch (field) {
      ...
      case 'female': {
        ...
        if (field === 'male') {
          return tags.some(t => t.startsWith('male:') && t.includes(value));
        }
        if (field === 'female') {
          return tags.some(t => t.startsWith('female:') && t.includes(value));
        }
