    ...
    public class Command
    {
            ...
            string[] hitomi_sync_range, string[] hitomi_sync_lookup_range, bool hitomi_sync_ignore_exists, string[] exhentai_lookup_page, bool sync_only_hitomi)
        {
            ...
            if (!low_perf)
            {
                ...
                {
                    download_data("https://raw.githubusercontent.com/TaYaKi71751/violet-database/refs/heads/main/hiddendata.json", "hiddendata.json");
                }
                if (!File.Exists("metadata.json"))
                    download_data("https://raw.githubusercontent.com/TaYaKi71751/violet-database/refs/heads/main/metadata.json", "metadata.json");
                if (!File.Exists("ex-hentai-archive.json"))
                    download_data("https://raw.githubusercontent.com/TaYaKi71751/violet-database/refs/heads/main/ex-hentai-archive.json", "ex-hentai-archive.json");
